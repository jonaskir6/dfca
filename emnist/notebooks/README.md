...
- Experiments on EMNIST using DFCA-GI, DFCA-Li and IFCA and lr=0.25, for further parameter settings see ```config_ifca.json```, ```config_dfca-gi.json```, ```config_dfca-li.json```
- Parameter settings: 
